...
if not st.session_state.logged_in:
    ...
    st.write(
        "A smart platform to report and manage "
        "campus emergencies quickly."
    )
    ...
    with c1:
        st.info("🚨 Emergency Reporting\n\n"
                "Quickly report campus emergencies.")

    with c2:
        st.info("🤖 AI Analysis\n\n"
                "Automatically analyze emergency priority.")

    c3, c4 = st.columns(2)

    with c3:
        st.info("👥 Response Teams\n\n"
                "Assign teams to emergency reports.")

    with c4:
        st.info("📊 Smart Analytics\n\n"
                "Monitor emergency reports and status.")
    ...
    st.caption(
        "🔒 Smart Campus Guardian | Safer & Smarter Campus"
    )
...
# =====================================================
    ...
    st.write("Report a campus emergency.")
    ...
    location_details = st.text_input(
        "Location Details",
        placeholder="Example: Near Room 204"
    )
    ...
    if st.button(
        ...
        if name and location_details and description:
            ...
            st.success("🚨 Emergency submitted successfully!")
...
# =====================================================
    ...
    st.write("Manage campus emergency reports.")
